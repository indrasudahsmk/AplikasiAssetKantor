                ...
                <div class="row mb-3">
                    ...
                    <div class="col-xl-6 mb-1">
                        ...
                        <select class="form-control @error('id_role') is-invalid @enderror" name="id_role">
                            <option disabled {{ old('id_role', $user->id_role) ? '' : 'selected' }}>-- PILIH ROLE --
                            </option>
                            <option value="1" {{ old('id_role', $user->id_role) == 1 ? 'selected' : '' }}>Admin
                            </option>
                            <option value="0" {{ old('id_role', $user->id_role) == 0 ? 'selected' : '' }}>Pegawai
                            </option>
                        </select>
                        @error('id_role')
                            <small class="text-danger">{{ $message }}</small>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-xl-6 mb-1">
                        ...
                        <select name="id_bidang" class="form-control w-100 @error('id_bidang') is-invalid @enderror">
                            <option disabled {{ old('id_bidang', $user->id_bidang) ? '' : 'selected' }}>-- PILIH BIDANG --
                            </option>
